...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-gray-200 min-h-[200px] sm:min-h-[250px] lg:min-h-[280px] flex flex-col py-4 sm:py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-4 sm:mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p className="flex items-start gap-2">
                ...
                <span>Old Shujabad Road, Multan, Pakistan</span>
              </p>
              <p className="flex items-center gap-2">
                <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-gray-600">+92 61 920 1601</span>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              <div
                className="w-10 h-10 flex items-center justify-center text-gray-400 rounded-lg cursor-not-allowed"
                aria-label="Facebook"
              >
